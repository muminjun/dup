...
void main() {
  ...
  group('isTrue()', () {
    ...
    test('default message contains label', () {
      final result = ValidateBool().setLabel('Consent').isTrue().validate(false)
          as ValidationFailure;
  ...
  group('isFalse()', () {
    ...
    test('uses messageFactory', () {
      final result = ValidateBool()
          ...
          .validate(true) as ValidationFailure;
    ...
    test('uses locale', () {
      ...
      final result = ValidateBool().setLabel('플래그').isFalse().validate(true)
          as ValidationFailure;
      expect(result.message, '플래그 거짓이어야 합니다.');
    });

    test('default message contains label', () {
      final result = ValidateBool().setLabel('Lock').isFalse().validate(true)
          as ValidationFailure;
