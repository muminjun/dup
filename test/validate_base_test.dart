...
void main() {
  ...
  group('equalTo()', () {
    ...
    test('fails when value does not equal target', () {
      final result =
          _StringValidator().setLabel('PW').equalTo('abc').validate('xyz');
      expect(result, isA<ValidationFailure>());
    ...
    test('uses messageFactory', () {
      final result = _StringValidator()
          ...
          .validate('xyz') as ValidationFailure;
  ...
  group('notEqualTo()', () {
    ...
    test('uses messageFactory', () {
      final result = _StringValidator()
          ...
          .validate('admin') as ValidationFailure;
  ...
  group('includedIn()', () {
    ...
    test('fails when value is not in allowed list', () {
      final result = _StringValidator()
          .setLabel('Role')
          .includedIn(['admin', 'user']).validate('guest');
      expect(result, isA<ValidationFailure>());
    ...
    test('context contains options string', () {
      final result = _StringValidator().includedIn(['x', 'y']).validate('z')
          as ValidationFailure;
      expect(result.context['options'], contains('x'));
    });

    test('uses messageFactory', () {
      final result = _StringValidator().setLabel('Role').includedIn(
        ['admin', 'user'],
        messageFactory: (label, p) => '$label 허용 값: ${p['options']}',
      ).validate('guest') as ValidationFailure;
    ...
    test('uses locale', () {
      ...
      final result = _StringValidator()
          .setLabel('역할')
          .includedIn(['a']).validate('b') as ValidationFailure;
  ...
  group('excludedFrom()', () {
    ...
    test('fails when value is in forbidden list', () {
      final result = _StringValidator()
          .setLabel('Word')
          .excludedFrom(['spam']).validate('spam');
      expect(result, isA<ValidationFailure>());
    ...
    test('uses messageFactory', () {
      final result = _StringValidator().setLabel('Word').excludedFrom([
        'spam',
      ], messageFactory: (label, _) => '$label 금지어 포함').validate('spam')
          as ValidationFailure;
    ...
    test('uses locale', () {
      ...
      final result = _StringValidator()
          .setLabel('단어')
          .excludedFrom(['spam']).validate('spam') as ValidationFailure;
  ...
  group('satisfy()', () {
    ...
    test('fails when condition returns false', () {
      final result =
          _NumValidator().setLabel('N').satisfy((v) => v! > 0).validate(-5);
      expect(result, isA<ValidationFailure>());
    ...
    test('uses messageFactory', () {
      final result = _NumValidator()
          ...
          .validate(50) as ValidationFailure;
